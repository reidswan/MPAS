        ...
        <div class="container col-md-8">
            <div class="form-group">
                ...
                <div class="col-md-8 col-xs-8">
                    ...
                    <asp:CustomValidator runat="server" ID="TitleValidator" ControlToValidate="Title_TextBox" OnServerValidate="Validate" CssClass="text-danger" ErrorMessage="Title cannot contain HTML"></asp:CustomValidator>
                </div>
            </div>
            <div class="form-group">
                <div class="col-md-4 col-xs-4">
                ...
                <div class="col-md-8 col-xs-8">
                    ...
                    <asp:CustomValidator runat="server" ID="ContentValidator" ControlToValidate="Content_TextBox" OnServerValidate="Validate" CssClass="text-danger" ErrorMessage="Title cannot contain HTML"></asp:CustomValidator>
